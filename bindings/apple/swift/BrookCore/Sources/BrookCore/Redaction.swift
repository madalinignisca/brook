...
extension FfiSession: CustomStringConvertible, CustomDebugStringConvertible, CustomReflectable {
...
extension LoginResult: CustomStringConvertible, CustomDebugStringConvertible, CustomReflectable {
    public var description: String {
        switch self {
